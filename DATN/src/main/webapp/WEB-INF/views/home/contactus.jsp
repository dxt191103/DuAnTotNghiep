...
<!-- Slideshow -->
    <section class="page-wrapper">
       <!-- maps section -->
        <div class="maps container-fluid" id="maps">
            <div class="row">
                <div class="maps-contact col-md-12" id="appointments">
                    ...
                    <div class="inner container">
                        <div class="row">
                            ...
                            <div class="contact-wrapper col-md-12 col-lg-5">
                                <div class="contact">
                ...
                <div class="maps-embed col-md-12 p-0">
                    <iframe
