		...
		<div class="row">
			...
			<div class="col-lg-9 order-1 order-lg-2">
						...
						<c:forEach var="item" items="${page.content}">
							<div class="col-lg-4 col-sm-6">
								<div class="product-item">
									<div class="pi-pic">
										<img style="width: 80%; height: 10rem;" src="${item.image}" alt="">
				...
				<div class="text-center">
					<a href="/home/brand?p=0" class="btn btn-primary">First</a> <a
						href="/home/brand?p=${page.number-1}" class="btn btn-primary">Previous</a>
					<a href="/home/brand?p=${page.number+1}" class="btn btn-primary">Next</a>
					<a href="/home/brand?p=${page.totalPages-1}" class="btn btn-primary">Last</a>
				</div>
				<hr />
			</div>
		</div>
