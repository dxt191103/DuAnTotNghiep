		...
		<div class="row">
			<div class="col-md-10 offset-md-1">
				...
				<div class="text-center">
					<a href="/admin/shift?p=0" class="btn btn-primary">First</a> <a
						href="/admin/shift?p=${page.number-1}" class="btn btn-primary">Previous</a>
					<a href="/admin/shift?p=${page.number+1}" class="btn btn-primary">Next</a>
					<a href="/admin/shift?p=${page.totalPages-1}"
